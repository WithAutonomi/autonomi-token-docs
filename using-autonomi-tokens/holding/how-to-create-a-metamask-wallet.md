---
description: >-
  MetaMask is a widely used Wallet that is fully compatible with Autonomi
  tokens, allowing you to hold, use, and receive them.
---
...
{% stepper %}
{% step %}
To begin, go to: [https://metamask.io/](https://metamask.io/) and **click Get MetaMask**.&#x20;
